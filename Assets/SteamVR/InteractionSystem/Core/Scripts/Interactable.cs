...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Interactable : MonoBehaviour
    {
        ...
        {
            highlightMat = (Material)Resources.Load("BossHighlight_HoverHighlight", typeof(Material));

            if (highlightMat == null)
                Debug.LogError("<b>[SteamVR Interaction]</b> Hover Highlight Material is missing. Please create a material named 'BossHighlight_HoverHighlight' and place it in a Resources folder");

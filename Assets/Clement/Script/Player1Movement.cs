...
public class Player1Movement: MonoBehaviour
{
    ...
    void Update()
    {
        MoveDir = new Vector3(Input.GetAxis("HorizontalPlayer1") * MovementSpeed,0f,Input.GetAxis("VerticalPlayer1") * MovementSpeed); // makes a new vector3 and addeds the controlers inputs to it.

        if(Input.GetButtonDown("JumpPlayer1") && Controller.isGrounded) // if the jump button is pressed adds the jump amount
        {
        ...
        if(Input.GetButton("TargetPlayer1"))
        {
